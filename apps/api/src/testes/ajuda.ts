...
export async function limparBanco(): Promise<void> {
  await prisma.$executeRawUnsafe(
    'TRUNCATE TABLE "Comprovante", "Gasto", "Recorrencia", "Meta", "Importacao", "Convite", "PedidoDeSenha", "Categoria", "Cartao", "Participacao", "User", "Household" RESTART IDENTITY CASCADE',
  );
}
